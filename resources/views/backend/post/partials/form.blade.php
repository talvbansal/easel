...
<div class="form-group">
    <div class="fg-line">
      ...
      <input class="form-control date-time-picker" name="published_at" id="published_at" type="text" value="{{ $published_at->format('d/m/Y H:i:s') }}" placeholder="DD/MM/YYYY HH:MM:SS" data-mask="00/00/0000 00:00:00">
    </div>
</div>
