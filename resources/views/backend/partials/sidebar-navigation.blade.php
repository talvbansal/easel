<aside id="sidebar" class="sidebar c-overflow">
    ...
    <ul class="main-menu">
        <li @if (Request::is('admin/post*')) class="active" @endif><a href="/admin/post"><i class="zmdi zmdi-view-compact"></i> Posts <span class="label label-default label-totals">{{ App\Models\Post::count() }}</span></a></li>
        <li @if (Request::is('admin/tag*')) class="active" @endif><a href="/admin/tag"><i class="zmdi zmdi-tag"></i> Tags <span class="label label-default label-totals">{{ App\Models\Tag::count() }}</span></a></li>
