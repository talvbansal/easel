...
$(document).ready(function() {
    ...
    /*
     * Find all forms on a page with an keyboard save class on a page when
     * the (control/cmd) + s combo is pressed and a form element is
     * focused make that form automatically submit ...
     */
